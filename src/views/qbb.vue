    ...
    <div class="qbb-content">
       <div class="qbb-tool">
           <ul>
               ...
               <li><i class="el-icon-edit"></i><a @click="openTree">开启群发</a></li>
               <li><i class="el-icon-edit"></i><a @click="closeTree">关闭群发</a></li>
           </ul>
       </div>
        <!-- 信息管理弹出框 -->
                    ...
                    <div style="height:300px; background:#fff;">
                        <el-tree              
                            ...
                            <span class="custom-tree-node" slot-scope="{ node }">
                                <i class="el-icon-share" v-if="node.label=='K17+500[诸向]'"></i>
                                <i class="el-icon-share" v-if="node.label=='K79+825[金向]'"></i>
                                ...
                                <!--右边-->
                                    <div class="grid-fsright">
                                        ...
                                        <el-row>
                                            <el-col :span="24"><div class="grid-content bg-purple-dark">
                                                    ...
                                                    <div style="height:200px;"> 
                                                        <el-table :data="shijiTable" border :header-cell-style="tableHeaderColor"  highlight-current-row style="width:100%; border:1px solid #DDDDDD;">
                                        ...
                                        <el-row :span="24">
                                            ...
                                            <el-col :span="8"><div class="grid-content bg-purple-dark">
                                                    ...
                                                    <div style="height:226px;"> 
                                                        <el-form ref="form" :model="sizeForm" label-width="100px" size="mini">
                                                                <el-form-item label="显示方式:" class="item" style="margin-top:4px; margin-bottom:4px;">
                                                                ...
                                                                <el-form-item label="发布人员:" class="item" style="margin-top:4px; margin-bottom:4px; width:70%;">
                                                                    ...
                                                                    <div style="float:right;margin-top:-30px;margin-right:10px;color:#09f;cursor: pointer;"><i class="el-icon-edit-outline">修改</i></div>
                                            ...
                                            <!--发送结果-->
                                            <el-col :span="15" style="marginLeft:23px;float:right"><div class="grid-content bg-purple-dark sj-grid">
